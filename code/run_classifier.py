...
def main():
    ...
    #loads model from pretraining
    model_state_dict = torch.load("../examples/models/pytorch_model.bin")  # torch.load(output_model_file)
    ...
    if args.do_train:
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
                ...
                output_eval_file = os.path.join(args.output_dir, "eval_results_" + str(epoch) + "ep.txt")
    ...
    #model_state_dict =  torch.load("../BERT/pytorch_model.bin") #torch.load(output_model_file)
